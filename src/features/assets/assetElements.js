export function getAssetElements() {
  return {
    ...
    manualCurrentPriceControl: document.querySelector("#manual-current-price-control"),
    manualCurrentPriceToggle: document.querySelector("#toggle-manual-current-price"),
    manualCurrentPricePanel: document.querySelector("#manual-current-price-panel"),
